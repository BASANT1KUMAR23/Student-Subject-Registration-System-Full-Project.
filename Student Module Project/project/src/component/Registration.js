  ...
  <div className="container py-5 h-70">
    <div className="row justify-content-center align-items-center h-70">
      <div className="col-12 col-lg-9 col-xl-7">
        <div className="card shadow-2-strong card-registration" id="border-radius: 15px;">
            ...
            <div className="">
              ...
              <div className="row">
                <div className="col-12">
                  ...
                  <label className="form-label select-label">Choose Branch</label>
                ...
                <div className="col-0">
                 ...
                 <select className="select form-control-lg">
                <option value="1" disabled>Choose Semester</option>
                 ...
                 <option value="4">Semester 8</option>
                   ...
                   <label className="form-label select-label">Choose Semester</label>
